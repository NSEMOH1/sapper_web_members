    ...
    return (
        <VStack spacing={6} align="stretch">
            ...
            <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={4}>
                ...
                {/* Service Information */}
                <GridItem>
                    <SectionCard title="Guarantor Info" icon={FileText}>
                        <VStack spacing={3} align="stretch">
                            <InfoRow
                                icon={FileText}
                                label="First Name"
                            ...
                            <InfoRow
                                icon={FileText}
                                label="Other Name"
                                value={guarantorInfo.other_name}
                            />
                            ...
                            <InfoRow
                                icon={FileText}
                                label="Nationality"
                                value={guarantorInfo.nationality}
                            />

                            <InfoRow
                                icon={FileText}
                                label="Address"
                                value={guarantorInfo.address}
                            />
                            ...
                            <InfoRow
                                icon={FileText}
                                label="Rank"
                                value={guarantorInfo.rank}
                            />

                            <InfoRow
                                icon={FileText}
                                label="State Of Origin"
                                value={guarantorInfo.state_of_origin}
                            />

                            <InfoRow
                                icon={FileText}
                                label="LGA"
                                value={guarantorInfo.lga}
                            />

                            <InfoRow
                                icon={FileText}
                                label="Unit"
                                value={guarantorInfo.unit}
                            />

                            <InfoRow
                                icon={FileText}
                                label="Email"
                                value={guarantorInfo.service_number}
                            />

                            <InfoRow
                                icon={FileText}
                                label="Date Of Birth"
                                value={guarantorInfo.date_of_birth}
                            />
